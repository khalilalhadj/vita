...
const animalsObj = [
	...
	{ name: 'Курица', url: new URL('../images/chicken.png', import.meta.url).href },
	...
	{ name: 'Жираф', url: new URL('../images/giraffe.png', import.meta.url).href },
	...
	{ name: 'Кролик', url: new URL('../images/rabbit.png', import.meta.url).href },
